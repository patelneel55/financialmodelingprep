...
describe('.commodities', () => {
    ...
    describe('.history', () => {
        ...
        it('should return data points between a time interval with a data limit', (done) => {
            chai.request('https://financialmodelingprep.com/api/v3')
                .get('/historical-price-full/commodity/ZGUSD?from=2018-03-12&to=2019-03-12&timeseries=5')
                .end((err, res) => {
        ...
        it('should return data points between a time interval with a data limit for a line graph', (done) => {
            chai.request('https://financialmodelingprep.com/api/v3')
                .get('/historical-price-full/commodity/ZGUSD?from=2018-03-12&to=2019-03-12&timeseries=5&serietype=line')
                .end((err, res) => {
